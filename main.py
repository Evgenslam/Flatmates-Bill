...
class ResultPage(MethodView):
    ...
    def post(self):
        ...
        amount, period, name1, days_in_house1, name2, days_in_house2 = [x.data for x in billform][:-1]
        bill = flat.Bill(amount, period)
        flatmate1 = flat.Flatmate(name1, days_in_house1)
        flatmate2 = flat.Flatmate(name2, days_in_house2)

        report = reports.PDFReport(filename=f'Bill for {period} for {name1} and {name2}.pdf')
